...
const SearchBar: React.FC<SearchBarProps> = ({ value, onChange, onFocus, onBlur, isSearchFocused, inputRef }) => (
    <div className="relative mt-6 group transition-all duration-500 w-full">
        ...
        ${isSearchFocused ? 'scale-105 shadow-xl ring-2 ring-blue-400 pl-14' : ''}`}
        />
        <div className="mt-2 text-xs text-gray-500">
            Tip: Only search by <span className="font-medium">Name & Surname</span> (without Dr / Dr. and so on)
        </div>
    </div>
);
