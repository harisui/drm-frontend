            ...
            {show && (
                <div className="absolute right-0 z-10 w-64 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-96 overflow-y-auto">
                    <div className="py-1">
                        ...
                        <button
                            onClick={onClear}
                            className={`block w-full px-4 py-2 text-left text-sm ${!selectedState && !selectedCity && !selectedCountry
                            ...
                            <>
                                ...
                                {availableCities.map((city) => (
                                    <button
                                        ...
                                        className={`block w-full px-4 py-2 text-left text-sm ${selectedCity === city
                                                ? 'bg-blue-50 text-blue-700'
                                                : 'text-gray-700 hover:bg-gray-100'
                                            }`}
                                    >
                            ...
                            <>
                                ...
                                {availableStates.map((state) => (
                                    <button
                                        ...
                                        className={`block w-full px-4 py-2 text-left text-sm ${selectedState === state
                                                ? 'bg-blue-50 text-blue-700'
                                                : 'text-gray-700 hover:bg-gray-100'
                                            }`}
                                    >
